...
namespace eEvento.Controllers
{
    public class ParticipantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ParticipanteId,Nome,Email,CPF")] Participante participante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ParticipanteId,Nome,Email,CPF")] Participante participante)
        {
            if (ModelState.IsValid)
            {
